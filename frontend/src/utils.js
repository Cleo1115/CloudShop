const domain = "https://dulcet-day-420802.uc.r.appspot.com"
...
export const login = (credential) => {
    return fetch(`${domain}/signin`, { 
        ...
        .then((response) => { // response is the res from the server
            if (!response.ok) {
                throw Error("Fail to log in");
            }
            // pick the string part in the res as a token to return
